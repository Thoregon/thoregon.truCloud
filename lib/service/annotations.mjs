...
import ChannelHistory               from "/thoregon.archetim/lib/mq/channelhistory.mjs";
import ChannelController            from "/thoregon.archetim/lib/mq/channelcontroller.mjs";
...
class OnMessageHandler {
    ...
    attachTo(target, handle, appinstance, home, opt) {
        ...
        const history          = this.getHistory(handle, servicename);
    ...
    getHistory(handle, servicename) {
        const histories = this.getHistories(handle);
