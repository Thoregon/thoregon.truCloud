...
export class ServiceHandleMeta extends MetaClass {
    ...
    initiateInstance() {
        ...
        this.text('source', { description: "source where to request a queue" });
        this.text('apiQuery', { description: "when true, the producer supports querying it's API" } )
        ...
        this.text('producer', { description: "contains settings for the producer. encrypted by the service provider" });
    }
