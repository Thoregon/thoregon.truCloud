...
export class AppInstanceMeta extends MetaClass {
    ...
    initiateInstance() {
        ...
        this.collection('queues',       Directory, { /*agent: true,*/ autocomplete: true, autoinit: true, description: 'extended app data root, manly for Service Agents' });
    }
...
export default class AppInstance extends ThoregonEntity() {
    ...
    static forApp(app, opt) {
        ...
        const instance = this.create({ id, appid: id, opt });
        instance._app = app;
/*
