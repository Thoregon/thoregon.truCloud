...
*/
    ...
    async auroraElement() {
        if (!AppElement) AuroraElement = (await import("/thoregon.aurora/lib/auroraelement.mjs")).default;
        return AppElement;
    }
    ...
    async appInstance(href) {
        ...
        try {
            ...
            return new App(this.descriptor.id);
        } catch (ignore) {
            this.logger.debug(ignore);
        }

        return new ThoregonApplication(this.descriptor.id);
    }
