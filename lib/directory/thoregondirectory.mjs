...
export default class ThoregonDirectory {
    ...
    async lookup(componentname) {
        return this.provider.lookup(componentname);
    }
     ...
     *
     * @param {String} componentname      ... provider dependent search string
     * @return {Promise<void>}
     */
    async list(componentname) {
    ...
    [Symbol.asyncIterator]() {
        return {
            ...
            async next() {
                ...
                return { done: false, value: await this[this.names.shift()] };
            },
            return() {
