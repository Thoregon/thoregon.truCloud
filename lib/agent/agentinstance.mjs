...
import Channel        from "/thoregon.archetim/lib/lightmq/channelsqlite.mjs";
...
*/
    ...
    async applyApp(specs) {
        ...
        try {
            ...
            const App       = (await thoregonImport(approot)).default;
            ...
            universe.logger.error("AgentInstance: apply App", e, e.stack);
        }
        return false;
    }
