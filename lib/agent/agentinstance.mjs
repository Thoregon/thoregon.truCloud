...
import install        from "../../../../ZZAttic/Heliots/reliant/heliots.app/test.mjs";
        ...
        for await (const { name, producer, consumer, spec, handle, appinstance, hooks } of producers) {
            ...
            try {
                ...
                if (create.includes(name)) {
                    await hooks.oninstall(consumer, settings);
                }
                await hooks.onattach(consumer, handle, appinstance);
